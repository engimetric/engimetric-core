...
async function seedDatabase() {
    ...
    try {
        ...
        await client.query(`
            ...
            (1, '{"github": {"enabled": true, "token": "", "org": "engimetric" }, "jira": {"enabled": true, "url": "https://engimetric.atlassian.net", "projectKey": "ISSUE", "token": "" }}', NOW(), NOW()),
            (2, '{"github": {"enabled": true, "token": "", "org": "engimetric" }, "jira": {"enabled": true, "url": "https://engimetric.atlassian.net", "projectKey": "QA", "token": "" }}', NOW(), NOW());
        `);
